	...
	return (
		<>
				...
				<div className={styles.container}>
					<div className={styles.hire}>
						...
						<p className={styles.description}>
							...
							with world-class technical and communication skills, without
							worrying about crazy fees or legal hassle.
						</p>
					</div>
					<div className={styles.hire}>
						<Image
			...
			<div className={styles.center}>
				<p>
					Join 160+ companies trusting Teamway for their remote engineering
					needs.
				</p>
			</div>
			<div>
				...
				<div className={styles.wrapper}>
					<div className={styles.icons}>
						...
						/>
						<SiIbm
							style={{ color: "black", fontSize: "60px", fontWeight: "bold" }}
						/>
						<FaPaypal
			...
			<main className={styles.wrapper}>
				<div className={styles.recruit}>
					<div className={styles.better}>
						{" "}
						<span>Recruit better, smarter, faster.</span>
					</div>
				...
				<div className={styles.flex}>
					<div className={styles.flex1}>
						<div className={styles.flexible}>
							...
							<p>
								Hire in just 72 hours.Scale your team up-and-down from
						...
						<div className={styles.decent}>
							...
							<p>
								Make your budget go up to 4x furtherby accessing talent directly
					...
					<div className={styles.flex1}>
						<div className={styles.talent}>
							...
							<p>
								Access the top 5% of talent that passes our indepth application
								and vetting process.
							</p>
						</div>
						<div className={styles.hassle}>
							...
							<p>
								Hiring remote independent talent used to be a struggle - not
								anymore! We handle the legal hassle for you.
							</p>
						</div>
					</div>
				</div>
